...
const achievementList = {
  ...
  2:{
    201:{
      ...
      progress:function(){return "If you are seeing this message then something has gone badly wrong."},
      visibility:function(){return true},
  ...
  5:{
    501:{
      ...
      check:function(){return true},
      progress:function(){return "This message only appears if you read the source code."},
      visibility:function(){return true},
