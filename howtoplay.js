...
const HTPtexts = [
  {
    ...
    dynamics:[
      function(){return (g.stardustUpgrades[1]>1||unlocked("Hawking Radiation"))?"various game mechanics":"exotic matter generation"}
    ]
  },
  {
    name:"Masteries",
    ...
    dynamics:[
      function(){return unlocked("Stardust")?" initially ":" "}
    ]
  },
  {
    name:"Achievements",
    visibility:function(){return g.ownedAchievements.length>0},
    paragraphs:[
  ...
  {
    name:"Stardust",
    visibility:function(){return unlocked("Stardust")||g.exoticmatter.gt(stardustExoticMatterReq)},
    paragraphs:[
    ...
    dynamics:[
      function(){return BEformat(stardustExoticMatterReq)}
    ]
  },
  {
    ...
    dynamics:[
      function(){return numword(stardustUpgradeCap(3)+2)}
    ]
  },
  {
  ...
  {
    name:"Wormhole",
    visibility:function(){return unlocked("Hawking Radiation")||totalAxis("dark").gt(1000)},
    paragraphs:[
  ...
  },
  {
    ...
    dynamics:[
      function(){return knowledgeEffectCap().toFixed(1)},
      function(){return g.permanentResearch.length>0?"Some Researches are permanent, and are unaffected by respec. These are distinguished with a white border around them.":""}
    ]
  },
  {
    name:"Studies",
    visibility:function(){return visibleStudies().length>0},
    paragraphs:[
