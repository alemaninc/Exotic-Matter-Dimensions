const newsSupport = {
	...
	formatZP:function(hideName=false){return N(g.zipPoints).format(2)+" Zip Point"+(g.zipPoints===1?"":"s")},
...
const newsList = [
	...
	{get text(){return newsSupport.jacorb.filter(x=>x.visible).map(x=>"You have "+x.value+" "+x.label+". <span style=\"color:#8a8767;text-shadow: 0px 1px 0px #a0a67c;\">(softcapped to "+x.softcapped+")</span>").join(". ")},get weight(){return g.XAxis.gt(c.d0)}},
